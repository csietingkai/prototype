...
export interface TypographyExampleState { }

class TypographyExample extends React.Component<TypographyExampleProps, TypographyExampleState> {

    constructor(props: TypographyExampleProps) {
        super(props);
        this.state = {};
    }
